    ...
    <div class="bg-linear-to-bl from-[#8AFF56] to-[#CB56FF]">
      ...
      <div class="flex flex-col gap-y-25 pb-20">
        <div class="flex items-center flex-col md:flex-row md:justify-between">
          ...
          <div class="flex flex-col pt-10 md:pr-50">
        ...
        <div class="flex items-center flex-col md:flex-row md:justify-between">
          ...
          <div class="flex flex-col pt-10 md:pr-50 md:flex-row gap-4">
        ...
        <div class="flex items-center flex-col md:flex-row md:justify-between">
          ...
          <div class="flex flex-col pt-10 md:pr-50 md:flex-row gap-10">
